-- 0012_refund_prompt_enhancement_credits.sql
--
-- Safely refunds credits for failed prompt enhancements.

CREATE OR REPLACE FUNCTION refund_prompt_enhancement_credits(
    p_user_id uuid,
    p_amount bigint,
...
BEGIN
    ...
    INSERT INTO credit_transactions (
        ...
        v_idempotency_key,
        'Refund for failed Gemini AI prompt enhancement',
        jsonb_build_object(
            'amount', p_amount
        )
